  ...
  return (
    <div className="center col full" style={{ flex: 1, gap: 20 }}>
      <div className="floaty fade-in" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <img src="/solaris-emblem-v2.png" alt="Solaris Holistic Health" style={{ width: 130, height: 130, objectFit: 'contain', filter: 'drop-shadow(0 0 18px rgba(47,190,159,0.5))' }} />
      </div>
...
function GoldenAge({ onNext, onSkip }) {
  ...
  return (
    <div className="center col full text-center" style={{ flex: 1, gap: 20, position: 'relative' }}>
      <SkipBtn onSkip={onSkip} />
      <div className="floaty"><img src="/solaris-emblem-v2.png" alt="Solaris" style={{ width: 72, height: 72, objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(47,190,159,0.4))' }} /></div>
  ...
  return (
    <div className="center col full text-center" style={{ flex: 1, gap: 24 }}>
      <div className="floaty" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <img src="/solaris-emblem-v2.png" alt="Solaris" style={{ width: 80, height: 80, objectFit: 'contain', filter: 'drop-shadow(0 0 12px rgba(47,190,159,0.45))' }} />
      </div>
